...
class User(models.Model):
    ...
    username = models.CharField(max_length=constants.NAME_LENGTH)
    password = models.CharField(max_length=constants.PASSWORD_LENGTH)
...
class Category(models.Model):
    ...
    description = models.CharField(
        max_length=constants.DESCROPTION_LENGTH,
...
class Payment(models.Model):
    payment_id = models.CharField(
        max_length=constants.PAYMENT_ID_LENGTH,
        primary_key=True
    )
