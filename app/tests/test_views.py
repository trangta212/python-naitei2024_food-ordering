...
from app.models import MenuItem, Order, Payment, Profile, Review, User, Restaurant, Order, Payment
...
class DashboardTestCase(TestCase):
    def setUp(self):
        ...
        self.client.login(email='testuser@example.com', password='password123')
        MenuItem.objects.create(restaurant=self.restaurant, name="Item 1", price=10)
        MenuItem.objects.create(restaurant=self.restaurant, name="Item 2", price=15)
        for i in range(5):
            payment = Payment.objects.create(payment_id=i, payment_date=datetime.now(), amount=50)
