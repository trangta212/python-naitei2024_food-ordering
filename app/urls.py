...
urlpatterns = [
    ...
    path(
        "dish/<int:item_id>/", views.DishDetail.as_view(), name="dish_detail"
    ),
    path(
        "dishfilter/<int:category_id>/",
...
urlpatterns += [
    ...
    path(
        "res/order-detail/<int:order_id>/",
        views.ResOrderDetailView.as_view(),
        name="res_order_detail",
    ),
